goog.provide('anychart.resourceModule.resourceList.Item');
 ...
 * @param {anychart.resourceModule.ResourceList} resourceList
 * @constructor
 * @extends {anychart.core.VisualBase}
 */
anychart.resourceModule.resourceList.Item = function(resourceList) {
  anychart.resourceModule.resourceList.Item.base(this, 'constructor');
 ...
 * @type {number}
 */
anychart.resourceModule.resourceList.Item.prototype.SUPPORTED_SIGNALS =
 ...
 * @type {number}
 */
anychart.resourceModule.resourceList.Item.prototype.SUPPORTED_CONSISTENCY_STATES =
 ...
 * @param {*} value
 */
anychart.resourceModule.resourceList.Item.prototype.setThemeOption = function(name, value) {
 ...
 */
anychart.resourceModule.resourceList.Item.prototype.getComplexOption = function(name, path) {
...
anychart.core.settings.populate(anychart.resourceModule.resourceList.Item, anychart.resourceModule.resourceList.Item.PROPERTY_DESCRIPTORS);
 ...
 */
anychart.resourceModule.resourceList.Item.prototype.applySettings = function(element, settings) {
  var key, value;
  for (key in settings) {
    value = settings[key];
 ...
 * @type {Object}
 */
anychart.resourceModule.resourceList.Item.DEFAULT_TAG_LABEL_SETTINGS = {
  'position': 'left-top',
  'anchor': 'left-top',
  'rotation': 0
};
 ...
 * @return {string|anychart.resourceModule.resourceList.Item} offsetY or self for chaining.
 */
anychart.resourceModule.resourceList.Item.prototype.offsetY = function(opt_value) {
 ...
 * @return {number}
 */
anychart.resourceModule.resourceList.Item.prototype.getActualHeight = function() {
 ...
 * @private
 */
anychart.resourceModule.resourceList.Item.prototype.createClipForImage_ = function() {
 ...
 */
anychart.resourceModule.resourceList.Item.prototype.calculateCoordinates = function(element, coords, fullImageWidth, margin, height) {
 ...
 * @private
 */
anychart.resourceModule.resourceList.Item.prototype.handleMouseClick_ = function(event) {
  var newEvent = {};
  if (event) {
...
//region --- DRAWING ---
/** @inheritDoc */
anychart.resourceModule.resourceList.Item.prototype.remove = function() {
...
/**
 * Draws resource item.
 * @return {anychart.resourceModule.resourceList.Item} Self for chaining.
 */
anychart.resourceModule.resourceList.Item.prototype.draw = function() {
...
/** @inheritDoc */
anychart.resourceModule.resourceList.Item.prototype.serialize = function() {
  return anychart.resourceModule.resourceList.Item.base(this, 'serialize');
};


/** @inheritDoc */
anychart.resourceModule.resourceList.Item.prototype.setupByJSON = function(json, opt_default) {
  anychart.resourceModule.resourceList.Item.base(this, 'setupByJSON', json, opt_default);
};


/** @inheritDoc */
anychart.resourceModule.resourceList.Item.prototype.disposeInternal = function() {
  ...
  anychart.resourceModule.resourceList.Item.base(this, 'disposeInternal');
};
//endregion
