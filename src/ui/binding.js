 ...
 * @private
 */
anychart.ui.binding.applyPath_ = function(target, path, pathArguments, opt_lastArgument) {
  var part;
  var name;
  var call;
  var args;
 ...
 * @private
 */
anychart.ui.binding.setRealValue_ = function(element) {
  var type = element.type;
  if (!goog.isDef(type)) return;
  type = type.toLowerCase();
