 ...
 * @return {Function}
 */
anychart.pieModule.Chart.getColorResolver = function(colorNames, colorType) {
 ...
 * @private
 */
anychart.pieModule.Chart.getColor_ = function(colorNames, normalizer, isHatchFill, pie, state, opt_ignorePointSettings) {
 ...
 * @return {*}
 */
anychart.pieModule.Chart.prototype.resolveOption = function(names, state, point, normalizer, opt_seriesName, opt_ignorePointSettings) {
  var val;
...
anychart.pieModule.Chart.prototype.updatePointOnAnimate = function(point) {
  ...
  if (hatchSlice) {
    ...
    var hatchFillResolver = anychart.pieModule.Chart.getColorResolver(['hatchFill', 'hoverHatchFill'], anychart.enums.ColorType.HATCH_FILL);
...
anychart.pieModule.Chart.prototype.colorizeSlice = function(pointState) {
  if (this.getOption('mode3d')) {
    ...
    if (goog.isDef(slice)) {
      var fillResolver = anychart.pieModule.Chart.getColorResolver(['fill', 'hoverFill'], anychart.enums.ColorType.FILL);
      ...
      var strokeResolver = anychart.pieModule.Chart.getColorResolver(['stroke', 'hoverStroke'], anychart.enums.ColorType.STROKE);
...
anychart.pieModule.Chart.prototype.createLegendItemsProvider = function(sourceMode, itemsFormat) {
  ...
  while (iterator.advance()) {
    ...
    var fillResolver = anychart.pieModule.Chart.getColorResolver(['fill'], anychart.enums.ColorType.FILL);
    var strokeResolver = anychart.pieModule.Chart.getColorResolver(['stroke'], anychart.enums.ColorType.STROKE);
    var hatchFillResolver = anychart.pieModule.Chart.getColorResolver(['hatchFill'], anychart.enums.ColorType.HATCH_FILL);
